    ...
    <div class="lifeStoryContent" v-if="displayLifeStoryContent">
      <div>
        ...
        <p class="description">
          ...
          окружающим миром. Время когда активно впитываются впечетления и начинают формироваться
          черты характера.
        </p>
        ...
        <div class="insideBlock">
          <MyTextarea
            placeholder-text="Опишите ваши отношения в жесттве, скорее всего в основном с семьёй"
      ...
      <div>
        ...
        <p class="description">
          Время созревания сопровождаемое множиством изменений, эксперементов и социального
          развития.
        </p>
        <div class="insideBlock">
          <MyTextarea
